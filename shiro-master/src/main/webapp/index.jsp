...
<shiro:user>
    <br/>
    <label style="margin-left: 20px;">欢迎高级用户：[<shiro:principal/>]登录，<a href="${pageContext.request.contextPath}/logout">点击退出</a></label>
    <br/>
    <hr/>
    <br/>
    <div style="margin-left: 5%;">

        <shiro:hasPermission name="role:test">
            <label>
                <div>
...
<!--可以写个if语音判断是什么角色，然后在div处写到底展现的是什么-->
</html>
